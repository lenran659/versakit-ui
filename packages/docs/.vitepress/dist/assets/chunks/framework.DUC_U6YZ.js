...
const ee = {},
  ...
  Do = /-(\w)/g,
  Pe = Mn((e) => e.replace(Do, (t, n) => (n ? n.toUpperCase() : ''))),
  $o = /\B([A-Z])/g,
  st = Mn((e) => e.replace($o, '-$1').toLowerCase()),
...
function wn(e, t) {
  ...
  if (((n = D(e)), (s = D(t)), n || s)) return n && s ? Go(e, t) : !1
  if (((n = Z(e)), (s = Z(t)), n || s)) {
    if (!n || !s) return !1
...
function ri(e) {
  ...
  for (; s; ) {
    const r = s.prevDep
    s.version === -1 ? (s === n && (n = r), Ds(s), zo(s)) : (t = s),
...
class Ln {
  ...
  track(t) {
    ...
    if (n === void 0 || n.sub !== ne)
      (n = this.activeLink = new Qo(ne, this)),
        ne.deps
...
const nl = Os('__proto__,__v_isRef,__isVue'),
  ci = new Set(
...
class ai {
  ...
  get(t, n, s) {
    ...
    if (n === '__v_raw')
      return s === (r ? (i ? hl : hi) : i ? di : ui).get(t) ||
...
function gl(e) {
  return e.__v_skip || !Object.isExtensible(e) ? 0 : pl(Ho(e))
}
function Fn(e) {
  return yt(e) ? e : js(e, !1, il, fl, ui)
}
function ml(e) {
  return js(e, !1, ll, ul, di)
}
function Hn(e) {
  return js(e, !0, ol, dl, hi)
}
...
class wl {
  ...
  get dep() {
    return Zo(J(this._object), this._key)
  }
}
class Sl {
  constructor(t) {
...
function Tn(e) {
  const t = ce
  return (ce = e), (wi = (e && e.type.__scopeId) || null), t
}
  ...
  Fl = {
    ...
    setup(e, { slots: t }) {
      ...
      return () => {
        ...
        if (a && a.type !== ve && !ut(c, a) && Ei(n).type !== ve) {
          let h = _s(a, o, s, n)
...
function ir(e) {
  if (!jn(e)) return Si(e.type) && e.children ? Ci(e.children) : e
...
function Ai(e, t = !1, n) {
  ...
  for (let i = 0; i < e.length; i++) {
    ...
    o.type === Se
      ? (o.patchFlag & 128 && r++, (s = s.concat(Ai(o.children, t, l))))
      : (t || o.type !== ve) && s.push(l != null ? nt(o, { key: l }) : o)
  }
  if (r > 1) for (let i = 0; i < s.length; i++) s[i].patchFlag = -2
  return s
}
/*! #__NO_SIDE_EFFECTS__ */ function Ri(e, t) {
  ...
  const {
    ...
    v = (g, p, A, j, V, q) => {
      ...
      if (ie || L !== -1) {
        ...
        let H = !1
        if (W(g)) {
          H = qi(null, se) && A && A.vnode.props && A.vnode.props.appear
...
function Li(e) {
  return e.some((t) =>
    Yt(t) ? !(t.type === ve || (t.type === Se && !Li(t.children))) : !0,
  )
    ? e
    : null
}
...
const bs = (e) => (e ? (io(e) ? Wn(e) : bs(e.parent)) : null),
...
function cc(e, t, n, s = !1) {
  ...
  n ? (e.props = s ? r : ml(r)) : e.type.props ? (e.props = r) : (e.props = i),
    (e.attrs = i)
}
function ac(e, t, n, s) {
  const {
        ...
        f == null
          ...
          : M > 0 && M & 64 && N && f.dynamicChildren
            ? (_(f.dynamicChildren, N, m, y, w, R, T),
              (d.key != null || (y && d === y.subTree)) && Gi(f, d, !0))
            : F(f, d, m, $, y, w, R, T, C)
    },
    k = (f, d, m, x, y, w, R, T, C) => {
      ;(d.slotScopeIds = T),
...
function _c(e, t, n) {
  const s = this.proxy,
    r = re(e) ? (e.includes('.') ? Ji(s, e) : () => s[e]) : e.bind(s, s)
  let i
...
function Tc(e, t = null, n = null, s = 0, r = null, i = !1) {
  ...
  const o = re(e) ? 1 : Zi(e) ? 128 : Si(e) ? 64 : Z(e) ? 4 : K(e) ? 2 : 0
...
function Nt(e, t) {
  ;(e.style.display = t ? e[On] : 'none'), (e[fo] = !t)
}
const Yc = Symbol(''),
  Xc = /(^|;)\s*display\s*:/
function Jc(e, t, n) {
  ...
  On in e && ((e[On] = i ? s.display : ''), e[fo] && (s.display = 'none'))
}
...
function bo(...e) {
  if (e.length !== 1) return xl(...e)
  const t = e[0]
  return typeof t == 'function' ? Hn(bl(() => ({ get: t, set: vo }))) : de(t)
}
function _a(e, t, n = {}) {
...
function Xs(e) {
  return So('(prefers-color-scheme: dark)', e)
}
function Ta(e) {
  return e == null
    ? 'any'
...
function If(e = {}) {
  ...
  if ((u(), Ys(u), Rt('resize', u, { passive: !0 }), r)) {
    const a = So('(orientation: portrait)')
    Fe(a, () => u())
  }
...
function Va(e, t) {
  ...
  return Object.assign({}, e, {
    ...
    head: Ro(e.head, ((c = e.locales[n]) == null ? void 0 : c.head) ?? []),
    themeConfig: {
      ...e.themeConfig,
...
const za = Symbol(),
  Oo = 'http://a.com',
  Qa = () => ({ path: '/', component: null, data: To })
function Nf(e, t) {
  const n = Fn(Qa()),
    s = { route: n, go: r }
